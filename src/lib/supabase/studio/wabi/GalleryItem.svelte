...
{:else if currentResource}
    <!-- Image tile -->
    <div 
        class="aspect-square overflow-hidden relative group cursor-pointer rounded-lg"
        role="group"
    ...
    >
        ...
        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity">
            <div class="absolute bottom-2 right-2">
                <button
                    class="h-8 w-8 bg-white/100 text-black rounded-md flex items-center justify-center text-sm hover:bg-white/90 shadow-md p-2"
