<script>
    ...
    async function handleGenerateImage() {
        try {
            await generateImage('generate-image-1111-runpod-local', imageDefaultParams);
...
<main>
    <Header text="Generate Image 1111 RunPod Local" />
    ...
    <ImageGallery prefix="image-1111-runpod-local" refreshTrigger={galleryRefreshTimestamp} />
</main>